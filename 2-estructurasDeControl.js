...
function verificarParidad(numero) {
    ...
    if (numero % 2 === 0) {  //lo que esta alado de "numero" vi en una de las lecciones y quise probar y funciono jaja
...
function cuentaRegresiva(numero) {
    let cuentaHaciaAtras = 10

    while (cuentaHaciaAtras > 0) {
        console.log(cuentaHaciaAtras)
        cuentaHaciaAtras = cuentaHaciaAtras - 1
    }
}
...
function obtenerDiaSemana(dia) {
    switch (dia) {
        ...
        case 5:
            ...
            break;
        case 6:
            console.log("hoy es Sabaduki");
            break;
        case 7: console.log("hoy es Domingorooo");
            break;
    }
}
